...
@injectable()
export class SearchResultsPersistenceService {
  constructor(
    @inject(ProductRepository)
    private readonly productsRepository: ProductRepository
  ) {}

  public async saveSearchResultToDb(
    ...
    await this.productsRepository.upsert(productsCatalogs)
    ...
    const products = await this.productsRepository.getByIds(productIds)
